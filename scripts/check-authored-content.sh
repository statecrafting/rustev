#!/usr/bin/env bash
# Spec: specs/001-boundaries-and-authority/spec.md (ownership in this repository)
#
# The organization's authored-content rules (U+2014, session links), made
# mechanical. Adapted from statecraft-cli at 9bb6188.
#
...
# history under merge commits. No
